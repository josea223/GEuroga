...
" > "$carpeta_nueva"/$codigo
# -------------------------------------------------------------------
# Ficha contacto

#touch "$carpeta_nueva"/$codigo.contacto
...
Teléfono: $telefono\n
Nota: $nota\n
" > "$carpeta_nueva"/$codigo.contacto

# ----------------------------------------------------------------
# Anuncio Facebook

#touch "$carpeta_nueva"/$codigo.facebook
...
" >> "$carpeta_nueva"/$codigo.facebook

printf "Precio: $moneda %'d" $PVP >> "$carpeta_nueva"/$codigo.facebook
...
$localizacion\n
$anuncio
" >> "$carpeta_nueva"/$codigo.clasipar

printf "Precio: $moneda %'d" $PVP >> "$carpeta_nueva"/$codigo.clasipar
